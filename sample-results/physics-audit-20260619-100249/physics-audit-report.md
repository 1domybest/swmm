...
- 산출 디렉터리: `/Users/onseoktae/Documents/swmm/sample-results/physics-audit-20260619-100249`
- 실행 조건: 강수 100%, 600초, SWMM link 전체 1개씩 100% 막힘
- 실행 시간: 281.2초
- 변환 결과: node 71개, link 65개, relation 내부 conduit 24개
- 변환 summary: `{"conduits": 65, "errors": 0, "inflowNodes": 15, "junctions": 61, "outfalls": 3, "pumps": 0, "storages": 7, "warnings": 6, "weirs": 0}`
...
## 3. 전체 막힘 테스트 요약
- inconclusive_no_baseline_flow: 20
- pass: 33
- suspect: 12

## 4. baseline에서 유량이 큰 link
- `pipe_free_1781771701381` / 파이프 / tailAbsFlow=0.012128 CMS / maxFull=3.5%
- `PIPE_STORM_MAIN_DROP_01` / 우수 본관 하강관 01 / tailAbsFlow=0.012021 CMS / maxFull=3.6%
- `PIPE_STORM_LATERAL_V_01` / 우수 연결관 수직 01 / tailAbsFlow=0.011111 CMS / maxFull=10.6%
...
- `REL_085_CONDUIT` / 관계 085: 빗물받이 04 → 우수 커넥터 04 / tailAbsFlow=0.011111 CMS / maxFull=3.6%
...
- [suspect] `pipe_free_1781771598332` / 파이프 / no_upstream_depth_response / flow reduction 99.9% / upstream delta 0.00%p / upstream depth 0.002m / baseline 0.001684 -> blocked 0.000001 CMS
...
- [suspect] `PIPE_STORM_MAIN_02` / 우수 본관 02 / no_upstream_depth_response / flow reduction 99.9% / upstream delta 0.00%p / upstream depth 0.007m / baseline 0.001149 -> blocked 0.000001 CMS
