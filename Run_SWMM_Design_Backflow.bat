...
set "ROOT=%~dp0"
set "MODEL=%ROOT%models\seoul_design_backflow.inp"
set "OUTDIR=%ROOT%run-results"
set "RPT=%OUTDIR%\seoul_design_backflow.rpt"
set "OUT=%OUTDIR%\seoul_design_backflow.out"
