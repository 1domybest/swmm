...
| `viewer/urban_flood_network_viewer.html` | 브라우저에서 보는 개념도 GUI |
...
즉 SWMM GUI는 “수리해석용 2D 관망도”에 가깝고, 발표용으로 직관적인 그림은 `viewer/urban_flood_network_viewer.html`을 여는 쪽이 더 좋습니다.
