...
set "ROOT=%~dp0"
set "MODEL=%ROOT%models\seoul_design_overflow.inp"
set "OUTDIR=%ROOT%run-results"
set "RPT=%OUTDIR%\seoul_design_overflow.rpt"
set "OUT=%OUTDIR%\seoul_design_overflow.out"
